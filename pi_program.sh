...
sudo avrdude -p atmega328p -C /home/pi/avrdude_gpio.conf -c pi_1 -D -v -e -u -U hfuse:w:0xDE:m -u -U lfuse:w:0xFF:m -u -U efuse:w:0x05:m 2>/home/pi/fuse_results.txt
...
sudo avrdude -p atmega328p -C /home/pi/avrdude_gpio.conf  -c pi_1 -D -v -u -U flash:w:$firmware:i -u -U lock:w:0x0F:m 2>/home/pi/flash_results.txt
