...
sudo avrdude -p $CHIP -C /home/pi/avrdude_gpio.conf  -c linuxspi -P /dev/spidev0.0 -b 3000000 -D -v -u -U flash:w:$firmware:i -u -U lock:w:$LOCK:m 2>/home/pi/flash_results.txt
